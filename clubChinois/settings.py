"""
Django settings for clubChinois project.
...
SECRET_KEY = 'django-insecure-5mf(zpen3!12-3p-pnpz5($3q&n8*ms91)=0i)3120*lots-25'
...
WSGI_APPLICATION = 'clubChinois.wsgi.application'
