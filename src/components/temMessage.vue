...
<template>
    <div class="tmsgBox"  ref="tmsgBox">
        <div class="tmsg-respond"  ref="respondBox">
            <h3>Leave your Comment <small v-show="isRespond" class="tcolorm" @click="removeRespond">Cancle replying</small></h3>
            <form class=""  >
                <el-input
                  type="textarea"
                  :rows="2"
        ...
        <div class="tmsg-comments"  ref="listDom">
            <a href="#" class="tmsg-comments-tip">Catch {{commentList?commentList.length:0}} item</a>
            <div class="tmsg-commentshow">
                            ...
                            <li class="tmsg-c-item" v-for="(citem,cindex) in item.ChildsSon" :key="'citem'+cindex">
                                <article class="">
                                    <header>
                                            ...
                                            <div class="i-name">
                                                {{citem.username}} <span>Reply</span> {{citem.reply_name}}
                                            </div>
                                            <div class="i-class">
                                                {{citem.label}}
                                            </div>
                ...
                <h1 v-show='hasMore' class="tcolors-bg" @click="addMoreFun" >More</h1>
                <h1 v-show='!hasMore' class="tcolors-bg" >No more</h1>
            </div>
        </div>
    </div>
</template>
