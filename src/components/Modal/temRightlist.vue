...
<template>
    <div class="rightlistBox">
        ...
        <section >
            ...
            <div class="r1-body">
                <div class="catch-me">
                    <div class="part_block" v-for="url in urls" :key="url">
                        <el-image
                        class='part_icon'
                        :src="url"
                        fit="fill"></el-image>
